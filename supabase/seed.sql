...
INSERT INTO systems (name, url, logo_url, description, status, display_order, enabled) VALUES
  ...
  ('rws', 'https://rws.dxt-ai.com', '/logos/rws.png', 'Real-time workspace collaboration and project management tool', NULL, 4, true),
  ('BINANCE', 'https://binance.dxt-ai.com', '/logos/binance.svg', 'Cryptocurrency portfolio tracking and analytics dashboard', NULL, 5, true)
